...
TWITTER_CATEGORY_MAP = {
    ...
    "walterbloomberg": "finance",
    "lizannsnders": "finance",
    "lizannsonders": "finance",
    "macroalf": "finance",
    "sentdefender": "geopolitics",
    "osinttechnical": "geopolitics",
    "faytuks": "geopolitics",
    "conflictnews": "geopolitics",
    "elianaljohnson": "geopolitics",
    "ragipsoylu": "geopolitics",
    "karpathy": "ai",
    "swyx": "ai",
...
REDDIT_CATEGORY_MAP = {
    ...
    "credibledefense": "geopolitics",
    "warcollege": "geopolitics",
    "machinelearning": "ai",
    "localllama": "ai",
...
class HorizonOrchestrator:
    ...
    def apply_balanced_digest(
        ...
        *,
        ...
        # First pass: reserve one slot for each configured group when possible so
        # every board has a chance to appear in the final digest.
        for group_key, group in groups.items():
        ...
        for item, group_key in selected:
            ...
            if group_key in groups:
                group_name = groups[group_key].name or group_key
            else:
                group_name = default_group
            item.metadata["category_group"] = group_key
            item.metadata["category_group_name"] = group_name
